...
sm.sendNext("Hello there, I'm #bMar the Fairy#k of Victoria Island's main disciple. "
            "Mar the Fairy summoned me here to see if the pets are being taken care of here in Ludibrium. "
            "What can I do for you?\r\n"
            "feel free to ask me questions.")


sm.sendNext("What do you want to know more of?#b\r\n"
...
selection = answer
if selection == 0:
    sm.sendNext("So you want to know more about Pets. Long ago I made a doll, "
                "sprayed Water of Life on it, and cast spell on it to create a magical animal. "
                "I know it sounds unbelievable, but it's a doll that became an actual living thing. "
                "They understand and follow people very well.")
    sm.sendNext("But Water of Life only comes out little at the very bottom of the World Tree, so I can't give him too much time in life... "
                "I know, it's very unfortunate... but even if it becomes a doll again I can always bring life back into it so be good to it while you're with it.")
    sm.sendNext("Oh yeah, they'll react when you give them special commands. You can scold them, love them... it all\r\ndepends on how you take care of them. "
                "They are afraid to leave their masters so be nice to them, show them love. They can get sad and lonely fast...")
    sm.sendNext("Depending on the command you give, pets can love it, hate, and display other kinds of reactions to it. "
                "If you give the pet a command and it follows you well, your intimacy goes up. "
                "Double click on the pet and you can check the intimacy, level, fullness and etc...")
    sm.sendNext("Talk to the pet, pay attention to it and its intimacy level will go up and eventually his overall level will go up too. "
                "As the intimacy level rises, the pet's overall level will rise soon after. "
                "As the overall level rises, one day the pet may even talk like a person a little bit, so try hard raising it. "
                "Of course it won't be easy doing so...")
    sm.sendNext("It may be a live doll but they also have life so they can feel the hunger too. "
                "#bFullness#k shows the level of hunger the pet's in. 100 is the max, and the lower it gets, "
                "it means that the pet is getting hungrier. After a while, it won't even follow your command and be on the offensive, "
                "so watch out over that.")
    sm.sendNext("Oh yes! Pets can't eat the normal human food. "
                "Instead my disciple #bDoofus#k sells #bPet Food#k at the Henesys Market so if you need food for your pet, find Henesys. "
                "It'll be a good idea to buy the food in advance and feed the pet before it gets really hungry.")
    sm.sendNext("Oh, and if you don't feed the pet for a long period of time, it goes back home by itself. "
                "You can take it out of its home and feed it but it's not really good for the pet's health, "
                "so try feeding him on a regular basis so it doesn't go down to that level, alright? I think this will do.")
    sm.sendNext("Dying... well, they aren't technically ALIVE per se, so I don't know if dying is the right term to use. "
                "They are dolls with my magical power and the power of Water of Life to become a live object. "
                "Of course while it's alive, it's just like a live animal...")
    sm.sendNext("After some time... that's correct, they stop moving. "
                "They just turn back to being a doll, after the effect of magic dies down and Water of Life dries out. "
                "But that doesn't mean it's stopped forever, because once you pour Water of Life over, it's going to be back alive.")
    sm.sendNext("Even if it someday moves again, it's sad to see them stop altogether. "
                "Please be nice to them while they are alive and moving. Feed them well, too. "
                "Isn't it nice to know that there's something alive that follows and listens to only you?")
if selection == 1:
    sm.sendNext("Depending on the command you give, pets can love it, hate, and display other kinds of reactions to it. "
                "If you give the pet a command and it follows you well, your intimacy goes up. "
                "Double click on the pet and you can check the intimacy, level, fullness and etc...")
if selection == 2:
    sm.sendNext("Dying... well, they aren't technically ALIVE per se, so I don't know if dying is the right term to use. "
                ...
                "Of course while it's alive, it's just like a live animal...")
if selection == 3:
    sm.sendNext("These are the commands for #rBrown Kitty and Black Kitty#k. "
...
if selection == 27:
    sm.sendNext("In order to transfer the pet ability points, closeness and level, "
                ...
                "scroll to Mar the Fairy in Ellinia, she will transfer the level and closeness of the pet to another one. "
                "I am especially giving it to you because I can feel your heart for your pet. However, I can't give this out for free. "
                "I can give you this book for 250,000 mesos. Oh, I almost forgot! Even if you have this book, it is no use if you do not have a new pet to transfer the Ability points.")

    if sm.sendAskYesNo("250,000 mesos will be deducted. Do you really want to buy?"):
        if sm.getMesos() < 250000 or not sm.canHold(4160011):
            sm.sendSayOkay("Please check if your inventory has empty slot or you don't have enough mesos.")
        else:
